...
const ControlledForm = () => {
  ...
  return (
    <form>
      <input className="firstName" type="text" value={formState.firstName} onChange={handleFirstNameChange} />
      <input className="lastName" type="text" value={formState.lastName} onChange={handleLastNameChange} />
      <input className="age" type="number" value={formState.age} onChange={handleAgeChange} />
    </form>
  )
}
